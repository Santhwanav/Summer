...
import 'package:navigator/favorite.dart';
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Icon(
                                Icons
                                    .search, // Replace 'Icons.search' with the appropriate icon from the Icons class.
                                color: Color.fromARGB(255, 127, 125, 125),
                              ),
                              SizedBox(
                                  width:
                                      8), // Adding some spacing between the icon and the text
                              Text(
                                'Search here...',
                                style: TextStyle(
                                  color: Color.fromARGB(255, 127, 125, 125),
                      ...
                      SizedBox(
                          height:
                              20), // Adding some spacing between the search bar and "Recent Searches" text
                      Text(
                        'Recent Searches',
                        style: TextStyle(
                          color: Colors.black,
                      ...
                      SizedBox(
                          height:
                              20), // Adding some spacing between "Recent Searches" text and the new widget
                      Column(
                        children: [
                          Row(
                            children: [
